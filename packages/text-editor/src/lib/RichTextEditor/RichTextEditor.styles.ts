  ...
  (
    ...
    root: {
      ...
      '& h1': {
        ...
        marginBottom:
          theme.spacing.sm * (theme.headings.sizes.h1.lineHeight as number),
      },

      '& h2': {
        fontSize: theme.headings.sizes.h2.fontSize,
        marginBottom:
          theme.spacing.sm * (theme.headings.sizes.h2.lineHeight as number),
      },

      '& h3': {
        fontSize: theme.headings.sizes.h3.fontSize,
        marginBottom:
          theme.spacing.sm * (theme.headings.sizes.h3.lineHeight as number),
      },

      '& h4': {
        fontSize: theme.headings.sizes.h4.fontSize,
        marginBottom:
          theme.spacing.sm * (theme.headings.sizes.h4.lineHeight as number),
      },

      '& h5': {
        fontSize: theme.headings.sizes.h5.fontSize,
        marginBottom:
          theme.spacing.sm * (theme.headings.sizes.h5.lineHeight as number),
      },

      '& h6': {
        fontSize: theme.headings.sizes.h6.fontSize,
        marginBottom:
          theme.spacing.sm * (theme.headings.sizes.h6.lineHeight as number),
      },
